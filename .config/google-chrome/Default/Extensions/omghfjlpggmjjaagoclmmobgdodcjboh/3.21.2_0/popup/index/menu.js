  ...
  Polymer({
      ...
      'containsFilter': {
        ...
        'statePath': function statePath(_ref6) {
          var domain = _ref6.domain,
              filters = _ref6['pac'].filters;

          /** @type {Array<String>} */
          var list = _.transform(filters, function (carry, _ref7) {
    ...
    openSettings: function openSettings(event) {
      ...
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var _event$target$getBoun, left, maxWidth, style, element;
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                if (!ShowedOffers.includes('smart settings')) {
                  ...
                  if (!_this.getState().pac.filters.length) {
                ...
                maxWidth = document.body.clientWidth - left;
                ...
                element = document.createElement('context-menu');

                element.setAttribute('style', style);

                // Setup of properties
                element.containsFilter = _this.containsFilter;
                element.domain = _this.domain;

                // Append node to body
                document.body.append(element);

                _this.documentClick = function (_ref8) {
                ...
                document.addEventListener('mousedown', _this.documentClick);
...
},{"polyfills/regeneratorRuntime":1}]},{},[2]);
